      ...
      <Container>
        <Form>
          <Form.Group controlId="formBasicEmail">
            ...
            <Form.Control type="email" placeholder="Enter email" onChange={this.myChangeHandlerUserName}/>
          ...
          <button name="data" type="button" onClick={this.checkCredentials}>Submit</button>
